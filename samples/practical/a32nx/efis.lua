...
local view_mappings = {
    ...
    {event=events.brkmed_push, action=filter.duplicator(
        msfs.mfwasm.rpn_executer("(L:A32NX_OVHD_AUTOBRK_MED_ON_IS_PRESSED, bool) ! (>L:A32NX_OVHD_AUTOBRK_MED_ON_IS_PRESSED, bool)"),
        filter.delay(200, msfs.mfwasm.rpn_executer("(L:A32NX_OVHD_AUTOBRK_MED_ON_IS_PRESSED, bool) ! (>L:A32NX_OVHD_AUTOBRK_MED_ON_IS_PRESSED, bool)"))
    )},
    {event=events.brkmax_push, action=filter.duplicator(
        msfs.mfwasm.rpn_executer("(L:A32NX_OVHD_AUTOBRK_MAX_ON_IS_PRESSED, bool) ! (>L:A32NX_OVHD_AUTOBRK_MAX_ON_IS_PRESSED, bool)"),
        filter.delay(200, msfs.mfwasm.rpn_executer("(L:A32NX_OVHD_AUTOBRK_MAX_ON_IS_PRESSED, bool) ! (>L:A32NX_OVHD_AUTOBRK_MAX_ON_IS_PRESSED, bool)"))
    )},
    {event=events.terronnd_push, action=msfs.mfwasm.rpn_executer("(L:A32NX_EFIS_TERR_L_ACTIVE) ! (>L:A32NX_EFIS_TERR_L_ACTIVE)")},
    {event=events.chrono_push, action=msfs.mfwasm.rpn_executer("0 (>H:A32NX_EFIS_L_CHRONO_PUSHED)")},
}
