...
module.actions = {}
module.actions[1] = {
    comswap = msfs.mfwasm.rpn_executer("(>H:AS530_COMSWAP_Push)"),
    navswap = msfs.mfwasm.rpn_executer("(>H:AS530_NAVSWAP_Push)"),
    rng_dezoom = msfs.mfwasm.rpn_executer("(>H:AS530_RNG_Dezoom)"),
    rng_zoom = msfs.mfwasm.rpn_executer("(>H:AS530_RNG_Zoom)"),
    directto = msfs.mfwasm.rpn_executer("(>H:AS530_DirectTo_Push)"),
    menu = msfs.mfwasm.rpn_executer("(>H:AS530_MENU_Push)"),
    clr = msfs.mfwasm.rpn_executer("(>H:AS530_CLR_Push)"),
    clr_long = msfs.mfwasm.rpn_executer("(>H:AS530_CLR_Push_Long)"),
    ent = msfs.mfwasm.rpn_executer("(>H:AS530_ENT_Push)"),
    cdi = msfs.mfwasm.rpn_executer("(>H:AS530_CDI_Push)"),
    obs = msfs.mfwasm.rpn_executer("(>H:AS530_OBS_Push)"),
    msg = msfs.mfwasm.rpn_executer("(>H:AS530_MSG_Push)"),
    fpl = msfs.mfwasm.rpn_executer("(>H:AS530_FPL_Push)"),
    vnav = msfs.mfwasm.rpn_executer("(>H:AS530_VNAV_Push)"),
    proc = msfs.mfwasm.rpn_executer("(>H:AS530_PROC_Push)"),
    left_large_knob_inc = msfs.mfwasm.rpn_executer("(>H:AS530_LeftLargeKnob_Right)"),
    left_large_knob_dec = msfs.mfwasm.rpn_executer("(>H:AS530_LeftLargeKnob_Left)"),
    left_small_knob_inc = msfs.mfwasm.rpn_executer("(>H:AS530_LeftSmallKnob_Right)"),
    left_small_knob_dec = msfs.mfwasm.rpn_executer("(>H:AS530_LeftSmallKnob_Left)"),
    left_small_knob_push = msfs.mfwasm.rpn_executer("(>H:AS530_LeftSmallKnob_Push)"),
    right_large_knob_inc = msfs.mfwasm.rpn_executer("(>H:AS530_RightLargeKnob_Right)"),
    right_large_knob_dec = msfs.mfwasm.rpn_executer("(>H:AS530_RightLargeKnob_Left)"),
    right_small_knob_inc = msfs.mfwasm.rpn_executer("(>H:AS530_RightSmallKnob_Right)"),
    right_small_knob_dec = msfs.mfwasm.rpn_executer("(>H:AS530_RightSmallKnob_Left)"),
    right_small_knob_push = msfs.mfwasm.rpn_executer("(>H:AS530_RightSmallKnob_Push)"),
}
--------------------------------------------------------------------------------------
