...
It’s easier to download and install the pre-compiled package from [here](https://github.com/opiopan/fsmapper/releases).<br>
However, you can also build it yourself　by follow the steps below.
...
[A sample code of a simple plugin module](sdk_samples/plugin_devices/simple_mod/simple_mod/simple_mod.cpp) and [an example Lua script](sdk_samples/plugin_devices/simple_mod/testscript.lua) for its usage are prepared, so please refer to it.<br>
