...
|--|--|
| [`fsmapper_setContext`](./fsmapper_setContext) | Associates a plugin-defined context pointer with the plugin module instance. |
| [`fsmapper_getContext`](./fsmapper_getContext) | Retrieves the context pointer previously associated with the plugin module instance. |
| [`fsmapper_setContextForDevice`](./fsmapper_setContextForDevice) | Associates a plugin-defined context pointer with a specific device instance. |
| [`fsmapper_getContextForDevice`](./fsmapper_getContextForDevice) | Retrieves the context pointer previously associated with a device instance. |
...
| Function | Description |
|--|--|
| [`fsmapper_raiseEvent`](./fsmapper_raiseEvent) | Notifies fsmapper of a state change in an INPUT device unit. |
...
| Function | Description |
|--|--|
| [`fsmapper_putLog`](./fsmapper_putLog) | Writes a log message to the fsmapper console with the specified log level. |
...
| Function | Description |
|--|--|
| [`fsmapper_abort`](./fsmapper_abort) | Requests immediate termination of the currently executing Lua script. |
