...
This helper is intended for reading string-based configuration or identifier values passed to plugin callbacks such as [`FSMDEV_OPEN`](../plugin_abi/FSMDEV_OPEN), without using the Lua C API directly.
