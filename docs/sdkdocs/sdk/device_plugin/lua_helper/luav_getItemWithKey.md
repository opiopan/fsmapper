...
This helper is primarily intended for accessing fields of the `identifier` or `options` table passed to the [`FSMDEV_OPEN`](../plugin_abi/FSMDEV_OPEN) callback function.
