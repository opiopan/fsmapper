...
This helper is designed for extracting numeric configuration or option values from Lua objects passed to plugin callbacks such as [`FSMDEV_OPEN`](../plugin_abi/FSMDEV_OPEN), without using the Lua C API directly.
