---
id: luav_getItemWithIndex
sidebar_position: 100
---

# luav_getItemWithIndex function

The **`luav_getItemWithIndex`** function retrieves a value from a Lua table referenced by a [`LUAVALUE`](../data_types) handle, using a numeric index.

This helper is primarily intended for accessing array-like elements of the `identifier` or `options` table passed to the [`FSMDEV_OPEN`](../plugin_abi/FSMDEV_OPEN) callback function.
...
- [`luav_getItemWithKey` function](./luav_getItemWithKey)
