...
* If a plugin has associated a custom context with the device using [`fsmapper_setContextForDevice`](fsmapper_setContextForDevice), it should be cleaned up here.
