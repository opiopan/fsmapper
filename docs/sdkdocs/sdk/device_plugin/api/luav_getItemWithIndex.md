...
This helper is primarily intended for accessing array-like elements of the `identifier` or `options` table passed to the [`FSMDEV_OPEN`](FSMDEV_OPEN) callback function.
