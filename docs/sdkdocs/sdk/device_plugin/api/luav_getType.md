...
|--|--|--|
|lv|[`LUAVALUE`](../data_types)|A handle that references a Lua value passed to the plugin, typically from the [`FSMDEV_OPEN`](FSMDEV_OPEN) callback.|
...
- [Lua Value Access Helper](../lua_helper)
