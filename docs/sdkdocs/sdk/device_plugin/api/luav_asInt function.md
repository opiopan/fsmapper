...
This helper is designed for extracting integer-style configuration or option values from Lua objects passed to plugin callbacks such as [`FSMDEV_OPEN`](FSMDEV_OPEN), without using the Lua C API directly.
