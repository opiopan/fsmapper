...
|Name|Description|
|--|--|
| FSMDU_DIR_INPUT  | Indicates an input unit that delivers values **from the plugin to fsmapper**. The plugin asynchronously notifies value changes by [`fsmapper_raiseEvent`](fsmapper_raiseEvent) function. 
...
* [`fsmapper_raiseEvent` function](fsmapper_raiseEvent)
