...
This helper is intended for extracting boolean-style configuration values from Lua objects passed to plugin callbacks such as [`FSMDEV_OPEN`](FSMDEV_OPEN), without requiring direct use of the Lua C API.
